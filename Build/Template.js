...
(function (Template) {
    async function Introduction() {
        ...
        async function getUserName() {
            ...
            await Template.fs.Speech.tell(null, "Bitte gib deinen Namen hier ein: ", true, 'start--screen');
            Template.userData.Protagonist.name = await Template.fs.Speech.getInput();
            Template.character.mainCharacter.name = Template.userData.Protagonist.name;
            Template.fs.Text.print("<p>Das Spiel beginnt!</p> <p>Tipp:</p> <p>Um weiterzukommen, kannst du dem Onkel fragen. <br> Folge unbedingt die Aufgaben, die der Onkel stellt. <brr> Du kannst dich an der Statistik (in Menu) orientieren.</p>");
            await Template.fs.Speech.tell(null, null, true);
